  ...
  try {
    ...
    const result = await pool.query(`
      ...
      SET name = COALESCE($1, name),
          ...
          card_bank_inn = $19,
          card_bank_mfo = $20,
          card_bank_legal_address = $21,
          card_bank_oked = $22,
          card_bank_okonx = $23,
          card_receipt_target = $24,
          support_username = $25,
          operator_registration_code = $26,
          payme_enabled = $27,
          payme_merchant_id = $28,
          payme_api_login = $29,
          payme_api_password = $30,
          payme_account_key = $31,
          payme_test_mode = $32,
          payme_callback_timeout_ms = $33,
          latitude = $34,
          longitude = $35,
          delivery_base_radius = $36,
          delivery_base_price = $37,
          delivery_price_per_km = $38,
          is_delivery_enabled = $39,
          delivery_zone = $40,
          msg_new = $41,
           msg_preparing = $42,
           msg_delivering = $43,
           ...
           ui_theme = $46,
           menu_view_mode = $47,
          payment_placeholders = COALESCE($48::jsonb, payment_placeholders),
           send_balance_after_confirm = COALESCE($49, send_balance_after_confirm),
          send_daily_close_report = COALESCE($50, send_daily_close_report),
          currency_code = $51,
          minimum_order_amount = $52,
          delivery_pricing_mode = $53,
          delivery_fixed_price = $54,
          is_scheduled_date_delivery_enabled = COALESCE($55, is_scheduled_date_delivery_enabled),
          scheduled_delivery_max_days = $56,
          is_asap_delivery_enabled = COALESCE($57, is_asap_delivery_enabled),
          is_scheduled_time_delivery_enabled = COALESCE($58, is_scheduled_time_delivery_enabled),
          receipt_logo_url = $59,
          receipt_header_text = $60,
          receipt_footer_text = $61,
          inventory_tracking_enabled = COALESCE($62, inventory_tracking_enabled),
          inventory_min_threshold = $63,
          menu_liquid_glass_enabled = COALESCE($64, menu_liquid_glass_enabled),
    ...
    `, [
      ...
      card_bank_inn || null,
      card_bank_mfo || null,
      card_bank_legal_address || null,
      card_bank_oked || null,
      card_bank_okonx || null,
